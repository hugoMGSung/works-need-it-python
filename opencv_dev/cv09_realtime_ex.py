...
while True:
    ...
    draw.text(xy=(10, 15),  text="동영상 웹캠 "+nowDatetime, font=font, fill=(255, 255, 255))
    ...
    if key == ord('r') and is_record == False:  # 현재 녹화상태가 아니며 r 키를 누르면
        ...
        video = cv2.VideoWriter("동영상 웹캠 " + nowDatetime_path + ".avi", fourcc, 15, (frame.shape[1], frame.shape[0]))
