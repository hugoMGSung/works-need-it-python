...
#scribble imports
from PyQt6.QtCore import QDir, QPoint, QRect, QSize, Qt, pyqtSignal
...
class MyMainGui(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        x = tf.Variable(initial_value=tf.random.normal([None, input_num_units]), trainable=True)
        # y = tf.placeholder(tf.float32, [None, output_num_units])
        y = tf.Variable(initial_value=tf.random.normal([None, output_num_units]), trainable=True)
